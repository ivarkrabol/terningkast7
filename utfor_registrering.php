<?php
    ...
    function mail_registrering($fornavn, $etternavn, $fodselsar, $adresse,
        ...
        $kommune_alt = strtoupper($kommune);
        $telefonnummer_alt = substr($telefonnummer, 0, 3)." ";
        $telefonnummer_alt .= substr($telefonnummer, 3, 2)." ";
        $telefonnummer_alt .= substr($telefonnummer, 5);
        ...
        <body><div id=\"super\">
        <img src=\"http://terningkast7.org/images/email_top_2.gif\" alt=\"Terningkast7\">
        <div id=\"page\">
        ...
        <td>$adresse</td><td>$postnummer</td><td>$poststed</td><td>$kommune_alt</td>
        <td>$telefonnummer_alt</td><td>$e_postadresse</td><td>".date("d.m.y")."</td>
        </tr></table>
    ...
    function mail_til_medlem($fornavn, $etternavn, $e_postadresse) {
        ...
        <body><div id=\"super\">
        <img src=\"http://terningkast7.org/images/email_top.gif\" alt=\"Terningkast7\">
        <div id=\"page\">
